...
- Tailscale tændt på Mac'en. Prøv først i Terminal:
  ...
  ```bash
  curl http://100.125.171.38:8000/health
  curl http://100.125.171.38:8000/notch
  ```
...
```
http://100.125.171.38:8000/notch
```
...
> Jarvis-adressen til `http://100.125.171.38:8000/notch` i Settings → Jarvis,
